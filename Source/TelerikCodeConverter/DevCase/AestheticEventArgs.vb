...
#Region " DevCase.Core.Types.AestheticEventArgs "
...
Namespace DevCase.Core.Types
    ...
    ''' <para></para>
    ''' A default (emptyness) class that inherits from <see cref="EventArgs"/>, with these base members hidden:
    ''' <para></para>
    ''' <see cref="EventArgs.GetHashCode"/>, <see cref="EventArgs.GetType"/>, 
    ''' <see cref="EventArgs.Equals(Object)"/>, <see cref="EventArgs.Equals(Object, Object)"/>,
    ''' <see cref="EventArgs.ReferenceEquals(Object, Object)"/>, <see cref="EventArgs.ToString()"/>.
    ''' </summary>
    ''' ----------------------------------------------------------------------------------------------------
    <ComVisible(True)>
    Friend MustInherit Class AestheticEventArgs : Inherits EventArgs

#Region " Constructors "

        ''' ----------------------------------------------------------------------------------------------------
        ''' <summary>
        ''' Initializes a new instance of the <see cref="AestheticEventArgs"/> class.
        ''' </summary>
        ''' ----------------------------------------------------------------------------------------------------
        Public Sub New()
            MyBase.New()
