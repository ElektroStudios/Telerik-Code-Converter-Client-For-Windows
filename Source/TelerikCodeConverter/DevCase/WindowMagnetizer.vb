...
#Region " DevCase.Application.UserInterface.Types.WindowMagnetizer "

Namespace DevCase.Application.UserInterface.Types
    ...
    ''' </example>
    ''' ----------------------------------------------------------------------------------------------------
    Friend Class WindowMagnetizer : Inherits AestheticNativeWindow : Implements IDisposable
...
#Region " Private Methods "
        ...
        ''' A pointer to a <see cref="DevCase.Interop.Win32.Types.WindowPos"/> structure that contains the 
