...
#Region " DevCase.Interop.Win32.Enums.WindowsMessages "
...
Namespace DevCase.Interop.Win32.Enums
    ...
    Friend Enum WindowsMessages As Integer
        ...
        ''' result of a call to the <c>NativeMethods.SetWindowPos</c> function or another window-management function.
        ''' <para></para>
        ''' 
        ''' <c>wParam</c> 
        ...
        ''' <para></para>
        ''' or when the window passes the <c>WindowsMessages.WM_SysCommand</c> message to the 
        ''' <c>DefWindowProc</c> function and the <c>wParam</c> parameter of the message
        ''' specifies the <c>Wparams.SC_Move</c> or <c>Wparams.SC_Size</c> value.
        ''' <para></para>
